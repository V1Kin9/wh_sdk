  ...
  switch(msg) {
    case U8X8_MSG_BYTE_SEND:
      ...
      while( arg_int > 0 ) {
        ...
        spi_send_byte(0x00,(uint8_t)*data);
        data++;
        arg_int--;
      }
      break;
    ...
    case U8X8_MSG_BYTE_START_TRANSFER:
      ...
      switch(u8x8->display_info->spi_mode) {
        ...
        //case 3: internal_spi_mode = SPI_MODE3; break;
          case 0: internal_spi_mode = 0x0; break;
          case 1: internal_spi_mode = 0x1; break;
          case 2: internal_spi_mode = 0x2; break;
          case 3: internal_spi_mode = 0x3; break;
      }
      SPI_REG(SPI_SR) = (SPI_REG(SPI_SR)&0xFC)|internal_spi_mode;
